          ...
          >
            <div className="mb-3">
              <CRow>
                ...
                <CCol className='col-3' xs>
                  <CFormRange min={0.00} max={1.00} step={0.01} value={video} defaultValue={video} onChange={(obj)=>{setVideo(obj.target.value)}} id="videoRange" label="video Range" />
                  <br/>
            ...
            <div className='mb-3'>
              <CRow>
                ...
                <CCol className='col-3' xs>
                  <CFormRange min={0.00} max={1.00} step={0.01} value={image} defaultValue={image} onChange={(obj)=>{setImage(obj.target.value)}} id="imageRange" label="Image Range" />
                  <br/>
