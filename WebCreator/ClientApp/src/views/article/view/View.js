              ...
              <CCardBody>
                ...
                <CCardText>
                  ...
                  {thumbImageArray.map((img, idx) => {
                    ...
                    return (
                      <>
                        &nbsp;<CImage key={"thumb"+idx} onClick={() => deleteImageConfirm(idx)} align="start" rounded src={(img.substr(0, 10) == "data:image" ? img : ("data:image/jpeg;base64," + img))} width={80} height={80} />
                      </>)
                  })}
